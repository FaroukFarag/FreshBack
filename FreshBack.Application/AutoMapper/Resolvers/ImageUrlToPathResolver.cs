...
public class ImageUrlToPathResolver<TSource, TDestination>(IOptions<ImageSettings> settings)
    ...
    where TDestination : class
{
    ...
    public string Resolve(TSource source, TDestination destination, string? destMember, ResolutionContext context)
    {
        ...
        return ImagePathHelper.ToRelativePath(imagePath, _settings.BaseUrl) ?? string.Empty;
    }
}
